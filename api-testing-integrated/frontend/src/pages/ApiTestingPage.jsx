...
export default function ApiTestingPage() {
  ...
  return (
    <div className="contentCard">
      <h2>API Testing Framework</h2>
      <p className="sectionSubtitle">
        Upload your Excel file, choose authentication, run the backend logic,
      ...
      <button className="primaryBtn" disabled={!canRun} onClick={runTests}>
